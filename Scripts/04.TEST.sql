...
SELECT * FROM TUTORS;
DELETE FROM USER_PICS WHERE ID IN (3);
...
DELETE FROM STUDENTS WHERE STUD_ID IN (5, 6);

INSERT INTO STUDENTS(STUD_ID, NAME, EMAIL,PHONE, DOB, GENDER) VALUES(4, 'long', 'long@gmail.com', '333-6666-7777', '1997-01-11', 0);

SELECT * FROM COURSES;

DELETE FROM COURSES WHERE COURSE_ID IN (4, 5, 6, 7);
